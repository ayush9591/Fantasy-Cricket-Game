...
class Ui_evaluate_team(object):
    ...
    def setupUi(self, evaluate_team):
        ...
        self.label.setGeometry(QtCore.QRect(90, 10, 391, 51))
        font = QtGui.QFont()
        ...
        self.selectteam_cb.setStyleSheet("color: rgb(25, 188, 220);\n"
...
"font: 75 italic 10pt \"Century Gothic\";")
        ...
        self.selectmatch_cb.setGeometry(QtCore.QRect(340, 70, 151, 22))
        font = QtGui.QFont()
        ...
        self.selectmatch_cb.setStyleSheet("color: rgb(25, 188, 220);\n"
"background-color: rgb(255, 255, 255);\n"
"font: 75 italic 11pt \"Century Gothic\";")
        ...
        self.label_2.setGeometry(QtCore.QRect(80, 150, 81, 21))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.label_2.setStyleSheet("color: rgb(62, 194, 42);")
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(evaluate_team)
        self.label_3.setGeometry(QtCore.QRect(340, 150, 81, 21))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.players_lw.setStyleSheet("color: rgb(25, 188, 220);\n"
"background-color: rgb(255, 255, 255);")
        ...
        self.scores_lw.setStyleSheet("color: rgb(25, 188, 220);\n"
"background-color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, evaluate_team):
        ...
        self.selectmatch_cb.setItemText(2, _translate("evaluate_team", "Match2"))
        self.selectmatch_cb.setItemText(3, _translate("evaluate_team", "Match3"))
