...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(60, 30, 299, 40))
        font = QtGui.QFont()
        ...
        self.openbtn.setGeometry(QtCore.QRect(130, 160, 93, 49))
        font = QtGui.QFont()
